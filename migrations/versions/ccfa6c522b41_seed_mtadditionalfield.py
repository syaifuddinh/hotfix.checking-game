...
def upgrade() -> None:
    op.execute('''
		...
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('idle-legends-god-saga', 'serverId', 'AUTOFILL', 'Server Name');
		...
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('jade-legends', 'serverId', 'OPTIONS', 'Server ID');
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('scroll-of-onymyoji', 'serverId', 'AUTOFILL', 'Server Name');
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('era-of-celestials', 'serverId', 'AUTOFILL', 'Server Name');
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('among-heroes-fantasy-samkok', 'serverId', 'OPTIONS', 'Server ID');
		INSERT INTO "MTAdditionalField" ("gameSlug", "additionalField", "additionalFieldType", "additionalFieldLabel") VALUES ('goddess-of-victory-nikke', 'serverId', 'OPTIONS', 'Server ID');
    ''')
