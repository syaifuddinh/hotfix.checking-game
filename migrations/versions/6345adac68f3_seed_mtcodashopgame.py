...
def upgrade() -> None:
    op.execute('''
		...
		INSERT INTO "MTCodashopGame" ("codashopSlug", "gameSlug", "additionalField", "additionalFieldType") VALUES ('era-of-celestials', 'era-of-celestials', 'server', 'AUTOFILL');
		...
		INSERT INTO "MTCodashopGame" ("codashopSlug", "gameSlug", "additionalField", "additionalFieldType") VALUES ('scroll-of-onmyoji-sakura--sword', 'scroll-of-onymyoji', 'server', 'AUTOFILL');
		...
		INSERT INTO "MTCodashopGame" ("codashopSlug", "gameSlug", "additionalField", "additionalFieldType") VALUES ('idle-legends', 'idle-legends-god-saga', 'serverName', 'AUTOFILL');
		...
		INSERT INTO "MTCodashopGame" ("codashopSlug", "gameSlug", "additionalField", "additionalFieldType") VALUES ('jade-legends-immortal-realm', 'jade-legends', 'server', 'OPTIONS');
